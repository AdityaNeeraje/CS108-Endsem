...
return;return this.each(function(){var $this=$(this);$(".socail-link-success-template-close").on("click",function(){$this.find(".form-success-template").remove();$this.find(".no-modal-form").removeClass('hide');$this.find(".hide-after-form-success").removeClass('hide');});});};})(jQuery);var LiveChat=new customLoader();LiveChat.init({id:'id-livechat',_loadScript:function($this){$this.isLoaded=1;if(environment!='production')return;if((typeof liveChatLoaded==="undefined")||liveChatLoaded||document.getElementById($this.id))return;window.__lc=window.__lc||{};window.__lc.license=12385578;;(function(n,t,c){function i(n){return e._h?e._h.apply(null,n):e._q.push(n)};var e={_q:[],_h:null,_v:"2.0",on:function(){i(["on",c.call(arguments)])},once:function(){i(["once",c.call(arguments)])},off:function(){i(["off",c.call(arguments)])},get:function(){if(!e._h)throw new Error("[LiveChatWidget] You can't use getters before load.");return i(["get",c.call(arguments)])},call:function(){i(["call",c.call(arguments)])},init:function(){var n=t.createElement("script");n.async=!0,n.type="text/javascript",n.src="https://cdn.livechatinc.com/tracking.js",t.head.appendChild(n)}};!n.__lc.asyncInit&&e.init(),n.LiveChatWidget=n.LiveChatWidget||e}(window,document,[].slice))
$this._postLead($this);},_postLead:function($this){if($this.isLoaded)
{LiveChatWidget.on('ready',function(initialData){urmParams=getUtmParams();$.each(urmParams,function(key,value){if(value===""||value===null){delete urmParams[key];}});LiveChatWidget.call('set_session_variables',{'utm_parameters':JSON.stringify(urmParams)});});}}});